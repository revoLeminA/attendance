    ...
    <div class="container">
        ...
        <form class="create-form" action="/register" method="post">
            ...
            <div class="form__item">
                <label class="form__item-ttl" for="name">名前</label>
                <input type="text" class="form__item-input" name="name" value="{{ old('name') }}">
            ...
            <div class="form__item">
                ...
                <input type="password" class="form__item-input" name="password_confirmation"
